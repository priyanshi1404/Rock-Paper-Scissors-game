...
public class rockpaperscissors{
    ...
    //used to take input from the computer
    
    public static String computerChoice(Random rd){
        int computerMove=rd.nextInt(3)+1;     //generates random number(acts as random moves generated by computer)
  ...
  public static void main(String args[]){
      ...
      while(continueplay){    //loop continues till the user wants to play the game
